...
a persistence unit "eva62MorochoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Morocho/pom.xml":
...
artifact ("eva62Morocho.war") is already built. You can build
